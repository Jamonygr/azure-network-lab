...
output "vm_spoke1_1_private_ip" {
  ...
  value       = var.deploy.spoke1_vms ? module.vm_windows["spoke1-1"].private_ip_address : null
}

output "vm_spoke1_2_private_ip" {
  description = "Private IP of second VM in Spoke1"
  value       = var.deploy.spoke1_vms ? module.vm_windows["spoke1-2"].private_ip_address : null
}

output "vm_spoke2_1_private_ip" {
  description = "Private IP of VM in Spoke2"
  value       = var.deploy.spoke2_vms ? module.vm_windows["spoke2-1"].private_ip_address : null
}

output "vm_onprem_1_private_ip" {
  description = "Private IP of VM in OnPrem"
  value       = var.deploy.onprem_vms ? module.vm_windows["onprem-1"].private_ip_address : null
}

output "vm_onprem_nva_private_ip" {
  description = "Private IP of NVA VM in OnPrem"
  value       = var.deploy.nvas ? module.vm_nva["onprem"].private_ip_address : null
}
...
output "vm_spoke1_nva_private_ip" {
  ...
  value       = var.deploy.nvas ? module.vm_nva["spoke1"].private_ip_address : null
}
